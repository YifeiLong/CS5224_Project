...
- NEED API for connecting with backend, backend need to define the API to get user input from front-end, and return results to front-end after model evaluation
