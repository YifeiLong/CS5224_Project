    ...
    <Box sx={{ maxWidth: '1000px', mx: 'auto', px: 3, py: 10 }}>
      ...
      <Box sx={{ textAlign: 'center', mb: 10 }}>
        ...
        <Typography variant="h6" color="#64748b" fontWeight={400} maxWidth="600px" mx="auto">
          We help homeowners and businesses unlock the true revenue potential of their rooftops using AI-driven solar analysis.
        </Typography>
      </Box>
          ...
          {[
            {
              ...
              body: "Our predictions are powered entirely by official government data — Singapore's historical sunshine hours, monthly rainfall patterns, and electricity tariffs sourced from data.gov.sg. Everything is grounded in 14 years of real, locally verified records.",
            },
            {
              title: 'Weather-Aware Forecasting',
              body: "Singapore's monsoon seasons directly affect how much solar energy your roof can generate. Our system accounts for rainfall likelihood and cloud cover month by month — not a generic tropical average.",
            },
            {
              title: 'From Sunshine to Kilowatt Hours',
              body: 'We convert weather forecasts into real energy numbers using the same physical formula trusted by the global solar industry. Roof size, local sun conditions, and panel efficiency are all factored in.',
            },
            {
            ...
            },
            {
              ...
              body: 'Free users get historical data and cost estimates. Pro users unlock AI yield forecasts, tariff projections, ROI timelines, and our AI consultant for property-specific questions.',
            },
          ].map((card) => (
            <Box key={card.title} sx={{
              p: 3, backgroundColor: '#fff', borderRadius: 3,
